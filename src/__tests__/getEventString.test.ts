...
describe('getEventString', () => {
  ...
  it('should normalize special keys', () => {
    expect(getEventString(createKeyboardEvent({ key: 'Escape' }))).toBe('escape');
    expect(getEventString(createKeyboardEvent({ key: 'Enter' }))).toBe('enter');
    expect(getEventString(createKeyboardEvent({ key: 'ArrowUp' }))).toBe('arrowup');
    expect(getEventString(createKeyboardEvent({ key: 'ArrowDown' }))).toBe('arrowdown');
